...
I'm a developer focused on **software development, open source, and AI-powered applications**. I enjoy solving problems, debugging real-world applications, and contributing to collaborative projects. Currently, I'm strengthening my skills through hands-on development, open-source contributions, and building practical solutions.

---

##  About Me

*  Currently working on **open-source projects and AI-focused applications**
*  Exploring **AI Agents, Generative AI, and modern software development**
*  Active **Open Source Contributor**
*  Interested in **debugging, problem solving, and improving existing applications**
*  Passionate about turning ideas into **practical, reliable software**
*  Continuously improving my **DSA, development, and engineering skills**
...
`Git` · `GitHub` · `GitHub Issues` · `Pull Requests` · `Code Review` · `Debugging`
...
I actively contribute to open-source projects, working with real-world repositories and collaborative development workflows.

My experience includes:

* Understanding and navigating existing codebases
* Investigating and reproducing software issues
